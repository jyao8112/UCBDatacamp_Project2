  ...
  data.forEach((food) => {
    ...
    row.on('click',function() {
      ...
      d3.json("/meterloc").then((data) => {
        ...
        // var meterMarkers = L.markerGroup();
        ...
        meterMarkers.push(
          L.marker([meters.meter1[1], meters.meter1[2]]).bindPopup("meter1")
        );
        meterMarkers.push(
          L.marker([meters.meter2[1], meters.meter2[2]]).bindPopup("meter2")
        );
        meterMarkers.push(
          L.marker([meters.meter3[1], meters.meter3[2]]).bindPopup("meter3")
        );
        meterMarkers.push(
          L.marker([meters.meter4[1], meters.meter4[2]]).bindPopup("meter4")
        );
        meterMarkers.push(
          L.marker([meters.meter5[1], meters.meter5[2]]).bindPopup("meter5")
        );
        meterMarkers.push(
          L.marker([meters.meter1[1], meters.meter1[2]]).bindPopup("meter1")
        );
        ...
        // Add all the meterMarkers to a new layer group.
        // Now we can handle them as one group instead of referencing each individually
        var meterLayer = L.layerGroup(meterMarkers);
